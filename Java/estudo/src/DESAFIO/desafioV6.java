/*- Arrumar carrinho
- Arrumar os loops 
- Colocar a opcao de excluir 
- Fazer um vetor auxiliar para quantidade 
- Arrumar UX
- Colocar os loops dentro dos If Else */
...
public class desafioV6 {
	...
	public static void main(String[] args) {
		...
		if(opc == 'S') {
			...
			System.out.print("Deseja acrescentar algum produto? Digite 1 para SIM ou 2 para NÃO: ");
			opcao1 = leia.nextInt();
			if (opcao1 == 1) {
				while (opcao1 == 1) {
					...
					System.out.printf("------------------CARRINHO DE COMPRAS-------------------------\n");
					System.out.printf("Seus produtos: %s\n VALOR TOTAL: %d R$", carrinho, subtotal);
				}
				if (opcao1 == 2) {
			...
			System.out.printf("\n %s, Obrigadx por utilizar o nosso programa!", nome);
